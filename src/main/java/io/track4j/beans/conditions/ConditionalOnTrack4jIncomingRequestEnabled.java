...
public class ConditionalOnTrack4jIncomingRequestEnabled implements Condition {
    private final Track4jProperties track4jProperties;

    public ConditionalOnTrack4jIncomingRequestEnabled() {
    ...
    public boolean matches(ConditionContext ctx, AnnotatedTypeMetadata md) {
        if (md.isAnnotated(ConditionalOnTrack4jIncomingEnabled.class.getName())) {
            return track4jProperties.isEnabled() && track4jProperties.isIncomingRequestTrackingEnabled();
        }
        return false;
    }
}